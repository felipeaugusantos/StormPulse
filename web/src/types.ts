...
// backend 409s instead of overwriting silently when it's stale. The web
// dashboard is always online, so it never needs the offline queue the
// mobile app has (mobile/src/fieldnotes/) — same endpoints either way.
