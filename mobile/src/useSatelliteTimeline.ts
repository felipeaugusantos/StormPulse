/** Ported from web/src/useSatelliteTimeline.ts (Fase 8, ADR-0091) — same
 * play/scrub-through-frames behavior, `setInterval` works the same way in
 * React Native as it does on the web. */
